...
define('DB_NAME', 'duyhung');
// [ACTION REQUIRED] endpoint of RDS instance
define('DB_ENDPOINT', 'duyhung.c7iac6e6akiq.us-east-1.rds.amazonaws.com');
...
define('DB_PHOTO_TABLE_NAME', 'duyhung');
